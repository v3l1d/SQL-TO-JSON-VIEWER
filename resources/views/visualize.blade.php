          ...
          //  console.log(JSON.stringify(returnedDatas));
            ...
            $flowchart.flowchart({
                ...
                onOperatorSelect: function(operatorId) { //V3l1d
                  ...
                  console.log(data);
                  $('#mySidebar').show();
                  $("#mySidebar").html("<br><h3>Tipo</h3><button id=\"primary\">Principale</button> <button id=\"secondary\">Secondaria</button> <button id=\"crossable\">Crossable</button> <br><hr><h3>Rinomina</h3><label style=\"display:inline-block; width: 140px;margin-top:10px;text-align: right;margin-right:10px;\">"+op['title']+"</label>" +"<input type=\"text\" id=\"title\"></input><br><hr>"+"<h3>Colonne</h3>");
                  var i=0;
